...
colorBackgIn	EQU 1100B	;淡红色		;动态标题栏内的背景（填充）颜色
colorBackgStr	EQU	0010B	;绿色		;动态标题栏下方提示字符串的背景颜色
colorCircle1	EQU 0100B	;红色		;圆圈的颜色1
...
DATAS SEGMENT
	...
	MESS0	db	'----------------------MENU------------------------',0DH,0AH
				...
				db	'Press 2 to draw a circle with a square in it.',0DH,0AH
...
call DynaTitle    ;按键1，动态显示标题
call Circle_Square;按键2，画圆和正方形
